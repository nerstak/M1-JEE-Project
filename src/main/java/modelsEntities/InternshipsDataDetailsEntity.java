...
@Entity
@Table(name = "internships_data_details", schema = "public", catalog = "st2eedb")
public class InternshipsDataDetailsEntity {
    ...
    public boolean equals(Object o) {
        ...
        InternshipsDataDetailsEntity that = (InternshipsDataDetailsEntity) o;
